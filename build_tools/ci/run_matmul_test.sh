...
export PATH=/usr/xilinx/Vitis/2024.2/aietools/bin:$PATH
...
if [ -z "${3-}" ]; then
  PEANO=/root/iree-amd-aie/llvm-aie
else
  PEANO=`realpath "$3"`
fi
if [ ! -d "${PEANO}" ]; then
...
AIE_TOOLS_DIR=/usr/xilinx/Vitis/2024.2/aietools
